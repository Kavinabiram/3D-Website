...
export const MoldingSection: React.FC = () => {
  return (
      ...
      <div className="max-w-md pointer-events-auto">
        ...
        >
          ...
          <p className="text-xs md:text-sm font-light text-cream-200/70 leading-relaxed">
            The shiny tempered chocolate is poured through automated dispensers into customized grid molds. Precision vibrations run through the molds to eliminate air bubbles and distribute the viscous chocolate evenly.
          </p>
          
          <div className="flex items-center gap-6 mt-2">
            <div>
              <div className="text-xl font-serif font-bold text-gold-500">100g</div>
              <div className="text-[8px] uppercase tracking-widest text-cream-200/40">Bar Weight</div>
            </div>
            <div className="w-[1px] h-8 bg-white/10" />
            <div>
              <div className="text-xl font-serif font-bold text-gold-500">0%</div>
              <div className="text-[8px] uppercase tracking-widest text-cream-200/40">Air Bubbles</div>
            </div>
          </div>
          ...
          <div className="mt-2 pt-2 border-t border-white/5">
            ...
            <span className="text-[10px] italic text-cream-200/50 block">
              Mechanical piston pneumatic hiss, clean chocolate pour, metallic taps.
            </span>
          </div>
        </motion.div>
      </div>
