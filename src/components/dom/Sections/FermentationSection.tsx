...
export const FermentationSection: React.FC = () => {
  return (
      ...
      <div className="max-w-md pointer-events-auto">
        ...
        >
          ...
          <p className="text-xs md:text-sm font-light text-cream-200/70 leading-relaxed">
            The cocoa beans are stored in large cascading wooden boxes covered in banana leaves. Over 5 to 7 days, intense microbial heat develops, transforming pale seeds into deep chocolate-brown flavor powerhouses.
          </p>
          
          <div className="flex items-center gap-6 mt-2">
            <div>
              <div className="text-xl font-serif font-bold text-gold-500">48°C - 50°C</div>
              <div className="text-[8px] uppercase tracking-widest text-cream-200/40">Microbial Heat</div>
            </div>
            <div className="w-[1px] h-8 bg-white/10" />
            <div>
              <div className="text-xl font-serif font-bold text-gold-500">6 Days</div>
              <div className="text-[8px] uppercase tracking-widest text-cream-200/40">Duration</div>
            </div>
          </div>
          ...
          <div className="mt-2 pt-2 border-t border-white/5">
            ...
            <span className="text-[10px] italic text-cream-200/50 block">
              Deep wood creaking, slow bubbling warmth, rising vapor hiss.
            </span>
          </div>
        </motion.div>
      </div>
