      ...
      <div className="max-w-md pointer-events-auto">
        ...
        >
          ...
          <p className="text-xs md:text-sm font-light text-cream-200/70 leading-relaxed">
            Our farmers hand-pick only the perfectly ripe yellow and orange cocoa pods. Each pod is carefully cut open in slow motion to reveal the fresh, wet cocoa beans covered in sweet mucilage.
          </p>
          
          <div className="flex items-center gap-6 mt-2">
            <div>
              <div className="text-xl font-serif font-bold text-gold-500">100%</div>
              <div className="text-[8px] uppercase tracking-widest text-cream-200/40">Hand Selected</div>
            </div>
            <div className="w-[1px] h-8 bg-white/10" />
            <div>
              <div className="text-xl font-serif font-bold text-gold-500">35-40</div>
              <div className="text-[8px] uppercase tracking-widest text-cream-200/40">Seeds Per Pod</div>
            </div>
          </div>
          ...
          <div className="mt-2 pt-2 border-t border-white/5">
            ...
            <span className="text-[10px] italic text-cream-200/50 block">
              Muffled snap of a branch, blade slicing wood, dripping pulp juice.
            </span>
          </div>
        </motion.div>
      </div>
